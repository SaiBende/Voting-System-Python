...
def showAllRecord():
    ...
    phone = Label(DataFrame, text="Phone No.", font=(
        LUCIDA_CONSOLE, 13, "bold"), bg="white", fg=HIGHLIGHT_TEXT)
    phone.place(x=220, y=20)
    gender = Label(DataFrame, text="Gender", font=(
        LUCIDA_CONSOLE, 13, "bold"), bg="white", fg=HIGHLIGHT_TEXT)
    gender.place(x=365, y=20)
    address = Label(DataFrame, text="Locality", font=(
        LUCIDA_CONSOLE, 13, "bold"), bg="white", fg=HIGHLIGHT_TEXT)
    ...
    y = 75
    for r in result:
        nameValue = Label(DataFrame, text=r[0], font=(
            ARIAL, 12, "normal"), bg="white")
        nameValue.place(x=x, y=y)
        x += 200
        phoneValue = Label(DataFrame, text=r[1], font=(
            ARIAL, 12, "normal"), bg="white")
        phoneValue.place(x=x, y=y)
        x += 160
        genderValue = Label(DataFrame, text=r[2], font=(
            ARIAL, 12, "normal"), bg="white")
        genderValue.place(x=x, y=y)
        x += 125
        addressValue = Label(DataFrame, text=r[3], font=(
            ARIAL, 12, "normal"), bg="white")
